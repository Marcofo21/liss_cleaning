...
search for `"liss_cleaning"` and replace it with a concise version of your project's
name. Importantly, you also need to rename the folder `src/liss_cleaning` to
